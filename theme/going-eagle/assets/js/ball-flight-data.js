...
window.GE_BALL_FLIGHT = {
  "FLIGHTS": {
    "left-right": {
      "id": "pull-slice",
      "name": "Pull slice",
      "impact": "The face was left of your target at impact, and the path was even further left of the face. That combination starts the ball left and tilts the spin axis hard to the right.",
      "causes": [
    ...
    "straight-right": {
      "id": "fade-slice",
      "name": "Straight slice",
      "impact": "The face was close to square to your target, but the path was left of the face. The start line looks fine, which is why this one is so frustrating.",
      "causes": [
    ...
    "right-right": {
      "id": "push-slice",
      "name": "Push slice",
      "impact": "The face was open to your target, and the path was left of that open face. This is the biggest miss in golf — it starts right and keeps going right.",
      "causes": [
    ...
    "right-left": {
      "id": "push-hook",
      "name": "Push hook",
      "impact": "The face was right of your target, and the path was even further right of the face. The ball starts right, then turns hard left.",
      "causes": [
    ...
    "straight-left": {
      "id": "straight-hook",
      "name": "Straight hook",
      "impact": "The face was near square to your target, with the path to the right of it. The ball sets off on line and then dives left.",
      "causes": [
    ...
    "left-left": {
      "id": "pull-hook",
      "name": "Pull hook",
      "impact": "The face was left of your target and the path was right of the face — a closed face with an in-to-out path. The two-way miss golfers fear most.",
      "causes": [
    ...
    "left-straight": {
      "id": "pull",
      "name": "Straight pull",
      "impact": "Face and path were matched, but both were aimed left of your target. Mechanically this is a good strike sent to the wrong address.",
      "causes": [
    ...
    "right-straight": {
      "id": "push",
      "name": "Straight push",
      "impact": "Face and path matched each other but both pointed right of the target. A well-struck shot with the wrong start line.",
      "causes": [
    ...
    "straight-straight": {
      "id": "straight",
      "name": "Straight",
      "impact": "Face and path were both square to the target and matched each other. There is nothing to fix here.",
      "causes": [
        "Nothing. This is the shot you are trying to hit."
      ],
      "fixes": [
        "A dead-straight ball is actually the hardest shot to repeat, because it needs two variables to be perfect at once. Most good players prefer a small, predictable curve they can aim off — it only needs one variable to stay consistent."
      ],
      "severity": "rare"
    }
  },
